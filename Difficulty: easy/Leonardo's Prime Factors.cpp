/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
  ...
  $   Institute: JKKNIU                         $
      Problem: O_Leonardo_s_Prime_Factors                
  $   Date: 2025/01/21                          $
  $   Time: 01:26:20                            $
  $                                             $
  $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$*/
...
int32_t main() {
    ...
    while(t--) {
        //cout << "Case " << ++cs << ": ";
        int n; cin>> n;
        vector<int> ans = {2, 6, 30, 210, 2310, 30030, 510510, 9699690, 223092870, 6469693230, 200560490130, 7420738134810, 304250263527210, 13082761331670030, 614889782588491410};
        int ress = 0;
        for(auto &it: ans) if(it <= n) ress++;
        cout << ress << endl;
    }
    return 0;
}
